...
def discriminator(x):
    with tf.variable_scope("discriminator"):
        ...
        bnorm1 = tf.layers.batch_normalization(conv1, axis=3, momentum=0.9, epsilon=1e-5, gamma_initializer=tf.random_normal_initializer(1,0.02))
        ...
        bnorm2 = tf.layers.batch_normalization(conv2, axis=3, momentum=0.9, epsilon=1e-5, gamma_initializer=tf.random_normal_initializer(1,0.02))
        ...
        bnorm3 = tf.layers.batch_normalization(conv3, axis=3, momentum=0.9, epsilon=1e-5, gamma_initializer=tf.random_normal_initializer(1,0.02))
        ...
        bnorm4 = tf.layers.batch_normalization(conv4, axis=3, momentum=0.9, epsilon=1e-5, gamma_initializer=tf.random_normal_initializer(1,0.02))
        ...
        bnorm5 = tf.layers.batch_normalization(conv5, axis=3, momentum=0.9, epsilon=1e-5, gamma_initializer=tf.random_normal_initializer(1,0.02))
...
def generator(z):
    with tf.name_scope("gen_block"):
        with tf.variable_scope("generator"):
            ...
            batch_norm=tf.layers.batch_normalization(reshaped, axis=3, momentum=0.9, epsilon=1e-5, gamma_initializer=tf.random_normal_initializer(1,0.02))
            ...
            bnorm3 = tf.layers.batch_normalization(deconv3, axis=3, momentum=0.9, epsilon=1e-5, gamma_initializer=tf.random_normal_initializer(1,0.02))
            ...
            bnorm4= tf.layers.batch_normalization(deconv4, axis=3, momentum=0.9, epsilon=1e-5, gamma_initializer=tf.random_normal_initializer(1,0.02))
...
with get_session() as sess:
    ...
    train_writer = tf.summary.FileWriter( "./cifar_deep_changes", sess.graph)
